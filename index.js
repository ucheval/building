...
// }
// //lets..use..it..here
// //this.AbortController.will..say..goodornign..alentin
// console.log(greet("valentine"))//yhis..willexpect..a.retun..i..not..it..will.bring..undeined...at..the..butto
// //so//we//use//
// greet("valentine")
...
//assignnnnnment
//create a funcrion that calculate simple intrest of a loan
...
//GLOBAL SCOOPE is a variable that can be accesed thought the entire program
...
//     console.log(name) 
// }
// fullName() //here..wont..work..bc..let..is..not..global..variable 

//JAVASCRIPT CLOSURE
//its a unction that rembers its scope een ater a function has been returned 

function newAccess() {
    let sentence = "I am a variable type of string";
    const innerFunction = () => {
...
inner(); // Output: I am a variable type of string
...
console.log(mycount()); // Output: 1
console.log(mycount()); // Output: 2
console.log(mycount()); // Output: 3
console.log(mycount()); // Output: 3
console.log(mycount()); // Output: 3
console.log(mycount()); // Output: 3
console.log(mycount()); // Output: 3
...
fruits[1] = "coco" //changing..orange..to..coco
fruits[3] = "pawpaw"//adding
fruits.push("apple", "chizboss", "manggo")//using push comand value to add to array


const myinfo = ["35", "aplaku", "ghana", "male"];
const myname = "valentine";
const fullname = `I am ${myname}, a ${myinfo[0]}-year-old ${myinfo[3]} living in ${myinfo[2]} and residing at ${myinfo[1]}. I love ${fruits[2]}.`;

console.log(fruits)

console.log(fruits[3])
//lets..remove from an array
fruits.pop()//this..removes the last element
console.log(fruits)


//rremoeing the first element o an array
fruits.shift()
console.log(fruits)
...
console.log(`we have ${fruits.length} in our array`)
...
console.log(`he is ${person.name} a ${person.age} year. i am ${determiestatus(person.isemployed)}`)